...
urlpatterns = [
    ...
    path('query/<int:fk>/comment/<int:pk>/update/', CommentUpdateView.as_view(), name='qcomment-update'),
    path('query/<int:fk>/comment/<int:pk>/delete/', CommentDeleteView.as_view(), name='qcomment-delete'),
